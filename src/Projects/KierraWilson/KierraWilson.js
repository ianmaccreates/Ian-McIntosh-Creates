...
const KierraWilson = () => {
  ...
  return (
    <div className="kw-page">
      <h2>Kierra Wilson</h2>
      <p className="kw-note">Use ← and → to navigate</p>
      <div className="kw-slider">
        <Slider ref={sliderRef} {...settings}>
          {images.map((img) => (
            <div key={img.id} className="kw-slide">
              <img src={img.src} alt={img.filename} className="kw-slide-img" loading="lazy" decoding="async" />
            </div>
          ))}
        </Slider>
      </div>
