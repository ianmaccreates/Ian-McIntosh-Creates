...
const TrinityPark = () => {
  ...
  return (
    <div className="tp-page">
      <h2>Trinity Park</h2>
      <p className="tp-note">Use ← and → to navigate</p>
      <div className="tp-slider">
        <Slider ref={sliderRef} {...settings}>
          {images.map((img) => (
            <div key={img.id} className="tp-slide">
              <img src={img.src} alt={img.filename} className="tp-slide-img" loading="lazy" decoding="async" />
            </div>
          ))}
        </Slider>
      </div>
