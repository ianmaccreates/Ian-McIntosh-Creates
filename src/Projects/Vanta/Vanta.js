...
const Vanta = () => {
  ...
  return (
    <div className="vanta-page">
      <h2>Vanta</h2>
      <p className="vanta-note">Use ← and → to navigate</p>
      <div className="vanta-slider">
        <Slider ref={sliderRef} {...settings}>
          {images.map((img) => (
            <div key={img.id} className="vanta-slide">
              <img src={img.src} alt={img.filename} className="vanta-slide-img" loading="lazy" decoding="async" />
            </div>
          ))}
        </Slider>
      </div>
